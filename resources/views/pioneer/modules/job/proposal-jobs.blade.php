    ...
    <div class="newjob_heading">
        ...
        <div class="job-card-btn job-card-btn pioneer-card-btn mt-3">   
            @if($j->pioneer_applicant_user!=null && $j->pioneer_applicant_user->interested==1)
                    <a href="{{route('pioneer.chat')}}" class="edit-btn outline-btn btn popup-btn">Message</a>
                                                                        
            @endif    
                <a href="{{route('pioneer.proposal',$j->_id)}}" class="edit-btn outline-btn btn popup-btn mt-md-0">View Details</a>
        </div>
...
@endforeach
                                    <div class="pagination-wrap active-job-pagination text-center mt-3 w-100 cstm-center"> 
                        {{$job->links()}}
                    </div> 
