    ...
    @endphp          
                ...
                @if(Auth::user()->email_verification==0)
                    ...
                    E-mail has been sent on your id for verification.
                          ...
                          @endif
                    <form id="msform" class="register-step2" action="{{route('pioneer.register.step2.save')}}" method="POST"  >
                        @csrf         
                        ...
                        <fieldset class=" step-card-inner shadow br-10">
                            ...
                            <a href="{{route('pioneer.register.step1')}}" name="previous" class="previous primary-btn bg-dark action-button-previous">Previous</a>
