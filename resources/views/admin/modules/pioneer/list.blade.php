<div class="table-body">
            ...
            <td><div class="switch-button switch-button-success switch-button-lg">
   			...
   			<td>
   				<ul class="action-btn-list">
   			        ...
   			        <li><a href="{{route('admin.pioneer.edit',$user->_id)}}" class="icon-btn"><i class="fas fa-edit"></i></a></li>
   			        <li><a href="{{route('admin.pioneer.view',$user->_id)}}" class="icon-btn"><i class="far fa-eye"></i></a></li>
                    <li><a href="{{route('admin.pioneer.job',$user->_id)}}" class="icon-btn"><i class="fas fa-briefcase"></i></a></li>
   		         </ul>
   		   </td>
   		</tr>
         @endforeach
   ...
   <div class="table-footer">
   	<label><?=listing($count,$pioneer->currentPage(),$list) ?></label>
