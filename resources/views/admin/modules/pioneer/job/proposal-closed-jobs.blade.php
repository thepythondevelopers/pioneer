                    ...
                    <div class="col-mf-9">
                        <div class="job-card-inner">
                            <div
                                ...
                                <img src="{{$j->created_user->logo!=null ? asset($j->created_user->logo) : asset('images/Resgister-step/company.png')}}" class=" br-10"
                                    alt="destination-img">
                            ...
                            <div class="job-card-btn">   
                                ...
                                <a href="{{route('admin.pioneer.closed.proposal.job.detail',$j->_id,$user_id)}}" class="outline-btn btn popup-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <li class="list-icon-card newJob_card">
                <div class="newjob_heading">
                    ...
                    <div class="job-card-btn job-card-btn pioneer-card-btn mt-3">   
                            ...
                            <a href="{{route('admin.pioneer.closed.proposal.job.detail',$j->_id,$user_id)}}" class="edit-btn outline-btn btn popup-btn mt-md-0">View Details</a>
                    </div>

                </div>
            </li>
@endforeach
                                    <div class="pagination-wrap active-job-pagination text-center cstm-center mt-3"> 
                        {{$job->links()}}
                    </div> 
       @else
