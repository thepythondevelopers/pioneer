            ...
            <div class="col-mf-9">
                <div class="job-card-inner">
                    ...
                    <div class="job-card-btn">
                        ...
                        <a href="{{route('admin.pioneer.closed.job.detail',[$j->_id,$user_id])}}"
...
<li class="list-icon-card newJob_card">
                <div class="newjob_heading">
                    ...
                    <div class="job-card-btn job-card-btn pioneer-card-btn mt-3">   
                            ...
                            <a href="{{route('admin.pioneer.closed.job.detail',[$j->_id,$user_id])}}" class="edit-btn outline-btn btn popup-btn mt-md-0">View Details</a>
                    </div>
