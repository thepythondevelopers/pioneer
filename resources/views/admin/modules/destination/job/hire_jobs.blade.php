                            ...
                            <div class="col-md-12">
                                <div class="job-card-inner">
                                    ...
                                    <div class="job-card-btn">
                                        ...
                                        <a href="{{route('admin.destination.hire.job.detail',$j->_id)}}" class="outline-btn btn popup-btn">View Details</a>
                                    </div>
                                </div>                                
                            </div>
                        </div>
                ...
                <li class="list-icon-card newJob_card">
                    <div class="newjob_heading">
                        ...
                        <div class="job-card-btn job-card-btn pioneer-card-btn mt-3">   
                                ...
                                <a href="{{route('admin.destination.hire.job.detail',$j->_id)}}" class="edit-btn outline-btn btn popup-btn mt-md-0">View Details</a>
                        </div>
